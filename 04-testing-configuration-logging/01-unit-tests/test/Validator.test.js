...
describe('testing-configuration-logging/unit-tests', () => {
  describe('Validator', () => {
    ...
    it('валидатор проверяет все условия, если передан некорректный тип поля', () => {
      const validator = new Validator({
        name: {
          type: 'string',
          min: 10,
      ...
      const errors = validator.validate({ name: 10, age: 15 });
      ...
      expect(errors[1]).to.have.property('error').and.to.be.equal('too little, expect 18, got 15');
    });
  });
});
